...
PARAM$ksemillas <-c(100169, 100183, 100189, 100237, 100267)
  ...
  for (vmin_split in c(1000, 800, 600, 400, 200, 100, 50, 20, 10)) {
    for (minbucket in c(500, 400, 300, 200, 50, 25, 10, 5)) {
      for (vcp in c(-0.85, -0.55, -0.15)) {
        ...
        cat( "vcp:", vcp, "\t","vmax_depth:", vmax_depth, "\t","vmin_split:", vmin_split, "\t", "minbucket:", minbucket, "\t","ganancia_promedio:", ganancia_promedio, "\n")
      }
    }
  }
}
